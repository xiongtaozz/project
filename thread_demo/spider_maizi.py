...
class spiderMaizi(threading.Thread):
    ...
    def analysis(self, count):
        ...
        # (.*)<a href="/[a-z]{0,}/[a-z]{0,}/[a-z]{0,}/[0-9]{0,}/" class="go font12">.*</a></p>[\s|\S]*?
        # <p class="color66 marginB14"><span class="color99">.*</span></p>[\s|\S]*?<p class="color66">
        # <span class="color99">.*</span>(.*)</p>[\s|\S]*?</div>'
