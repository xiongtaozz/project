    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(unique=True, max_length=254, verbose_name=b'email address', blank=True)),
                ('qq', models.CharField(max_length=13, null=True, verbose_name=b'qq', blank=True)),
                ('phone', models.CharField(max_length=11, null=True, verbose_name=b'phone', blank=True)),
            ...
            managers=[
                ('objects', myuser.models.UserProfileManager()),
            ],
        ),
        migrations.CreateModel(
            name='Article',
