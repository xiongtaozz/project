...
class Book(models.Model):
    ...
    product_date = models.DateTimeField(verbose_name=u'出版时间', auto_now_add=False, max_length=30)
    # 2015-12-23 20:51:27
...
class Cart(models.Model):
    ...
    book = models.ForeignKey(Book)  # from.models
    # models.OneToOneField(User,related_name='id')
