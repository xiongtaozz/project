    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publishing', models.CharField(default=b'CD', max_length=50, verbose_name='\u51fa\u7248\u793e', choices=[(b'CD', b'\xe5\x9b\x9b\xe5\xb7\x9d\xe5\xa4\xa7\xe5\xad\xa6'), (b'SH', b'\xe4\xb8\x8a\xe6\xb5\xb7\xe5\xa4\xa7\xe5\xad\xa6'), (b'BJ', b'\xe5\x8c\x97\xe4\xba\xac\xe5\xa4\xa7\xe5\xad\xa6'), (b'SZ', b'\xe6\xb7\xb1\xe8\xaf\x81\xe5\xa4\xa7\xe5\xad\xa6')])),
                ...
                ('author', models.ForeignKey(to='cart.Author')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(to='cart.Book')),
            ],
            options={
                'ordering': ['-id'],
                'db_table': 'cart',
                'verbose_name': '\u8d2d\u7269\u8f66',
                'verbose_name_plural': '\u8d2d\u7269\u8f66\u5185\u5bb9',
            },
        ),
        migrations.CreateModel(
            name='User',
