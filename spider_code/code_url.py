...
# # request = urllib2.Request('http://www.baidu.com') # post
...
# # data = urllib.urlencode(values)  # get post  pasd=1&user='xxx'
# # print data
...
# values = {'username': '33100@qq.com', 'password': '12345678'}
# # 低级 user-agent -->高级: 防盗链 -->cookie(简单) --->js cookie
...
# 使用soket访问网页
HOST = 'www.youku.com'    # The remote host
