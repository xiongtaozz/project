...
login_url = 'http://www.guahao.com/user/login_a'
...
while True:
    ...
    values = {'loginId': '18030561191', 'password': 'f4d820cd555b58fe27ec6a56c4b90b1d', 'validCode': varcode, 'method': 'dologin', 'target': '/'}
